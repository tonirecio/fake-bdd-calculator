...
@ex_OperationsKeyboard
Scenario Outline: Performing two number operations with keyboard
Given the user writes the following value: "<displayNumber>"
...
Examples:
| displayNumber |    key | userNumber | displayResult |
|            24 |      + |          6 |            30 |
|            24 |      - |          6 |            18 |
|            10 |      * |          8 |            80 |
|            10 |      / |          2 |             5 |